...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Calm Terminal — Understand crypto markets in 30 seconds" },
      {
        name: "description",
        content:
          "A market interpretation layer for crypto. The Truth Engine turns raw price data into clear, readable insight — what changed, what matters, what it means.",
      },
      { property: "og:title", content: "Calm Terminal — A market interpretation layer for crypto" },
      {
        property: "og:description",
        content:
          "Understand crypto markets in 30 seconds. Plain-language interpretation, not more indicators.",
      },
      { property: "og:url", content: "https://calm-chart-space.lovable.app/" },
    ],
    links: [{ rel: "canonical", href: "https://calm-chart-space.lovable.app/" }],
  }),
});
